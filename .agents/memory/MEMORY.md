...
- [Mobile UX Patterns](mobile-ux.md) — Responsive patterns for song request/karaoke apps
- [Logo Sizing Strategy](logo-sizing.md) — Breaking out of max-w containers for full-width hero elements
